...
import { FaPrint, FaTimes, FaSave, FaEdit} from "react-icons/fa";
            ...
            {showModel && modelType === "view" && (
                <Model onClose={handleCloseModel}>
                    <div className="w-full flex justify-center items-center mb-4">
                        <button
                                        className="flex items-center gap-3 bg-red-500 py-2 px-4 rounded"
                        ...
                        <div className="w-full">
                            <div className="w-full text-left">
                                ...
                                <div className="w-full flex justify-end py-2 ">
                                    <button
                                        className="flex items-center gap-3 bg-green-500 py-2 px-4 rounded"
                                    ...
                                    <button
                                        className="flex items-center gap-3 bg-blue-500 py-2 px-4 rounded ml-4"
                                        onClick={() => window.print()}
                                    >
                                        <FaPrint />
                                        Print
